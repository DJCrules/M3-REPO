...
csv_file = "D:/M3 Repository/M3-REPO/Exponential_Smoothing/Liverpool_revenue.csv"  # Change this to your file path
...
# Function to apply Exponential Smoothing to a revenue stream
...
# Create a continuous total revenue series (historical + forecast)
...
# Get the last forecasted year only
