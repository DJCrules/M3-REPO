...
class polynomial_trend:
    ...
    def generate_poly_data(self, order, num_points=100, noise_level=1.5):
    ...
    def plot_data(self, coefficients=None, extra=0):
    ...
    def regress(self, order, rate=0.000001, tolerance=0.01, max_iterations=1000):
        coefficients = np.random.normal(0, 1, order + 1)
...
newtrend = polynomial_trend('.\Polynomial\sample_data.csv', 3, True)
cos = newtrend.regress(3)
newtrend.plot_data(cos, 2)